...
require("1 篇總覽 · 4 個工具" in article_index, "article index practical trading count label missing")
for filename in ["17-practical-trading.html", *[f"../../academy/tools/{name}.html" for name in TOOL_NAMES]]:
