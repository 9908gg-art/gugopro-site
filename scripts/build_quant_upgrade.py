...
<label for="win">勝率（%）</label><input id="win" type="number" min="0.01" max="99.99" step="0.1" value="50">
<label for="avgwin">平均獲利（R）</label><input id="avgwin" type="number" min="0.01" step="0.01" value="1.5">
<label for="avgloss">平均虧損（R）</label><input id="avgloss" type="number" min="0.01" step="0.01" value="1">
...
<label for="account">帳戶資金（元）</label><input id="account" type="number" min="0" step="1" value="100000">
<label for="stop">單筆停損距離（%）</label><input id="stop" type="number" min="0.01" max="100" step="0.1" value="5">
...
$('calc').addEventListener('click',calc);calc();</script></body></html>'''
